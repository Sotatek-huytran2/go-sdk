...
import (
	...
	"github.com/Sotatek-huytran2/go-sdk/client/rpc"
	...
	sdk "github.com/Sotatek-huytran2/go-sdk/client"
	"github.com/Sotatek-huytran2/go-sdk/client/transaction"
	"github.com/Sotatek-huytran2/go-sdk/common"
	ctypes "github.com/Sotatek-huytran2/go-sdk/common/types"
	"github.com/Sotatek-huytran2/go-sdk/keys"
	"github.com/Sotatek-huytran2/go-sdk/types/msg"
	txtype "github.com/Sotatek-huytran2/go-sdk/types/tx"
)

// After aximchain integration_test.sh has runned
func TestTransProcess(t *testing.T) {
	...
	//-----   time lock  -----------
	lockResult, err := client.TimeLock("test lock", ctypes.Coins{{"AXC", 100000000}}, int64(time2.Now().Add(65*time2.Second).Unix()), true)
	assert.NoError(t, err)
	fmt.Printf("timelock %d", lockResult.LockId)

	//----- time relock ---------
	relockResult, err := client.TimeReLock(lockResult.LockId, "test lock", ctypes.Coins{{"AXC", 200000000}}, int64(time2.Now().Add(65*time2.Second).Unix()), true)
	assert.NoError(t, err)
...
func TestAtomicSwap(t *testing.T) {
	...
	amount := ctypes.Coins{ctypes.Coin{"AXC", 10000}}
	expetedIncome := "10000:AXC"
