...
import (
	...
	sdk "github.com/Sotatek-huytran2/go-sdk/common/types"
	"github.com/Sotatek-huytran2/go-sdk/keys"
	gtypes "github.com/Sotatek-huytran2/go-sdk/types"
...
// example:
// 1. currentCommitHeight: 1000, accountA(balance: 10AXC, sequence: 10)
// 2. height: 999, accountA(balance: 11AXC, sequence: 9)
// 3. GetCommitAccount will return accountA(balance: 11AXC, sequence: 9).
// If the (currentHeight-1) do not exist, will return  account at currentHeight.
// 1. currentCommitHeight: 1000, accountA(balance: 10AXC, sequence: 10)
// 2. height: 999. the state do not exist
// 3. GetCommitAccount will return accountA(balance: 10AXC, sequence: 10).
...
// example:
// 1. AccountA(Balance: 10AXC, sequence: 1), AccountB(Balance: 5AXC, sequence: 1)
// 2. Node receive Tx(AccountA --> AccountB 2AXC) and check have passed, but not included in block yet.
// 3. GetAccount will return AccountA(Balance: 8AXC, sequence: 2), AccountB(Balance: 7AXC, sequence: 1)
